...
namespace AmazonMVCv2.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentID,PaymentType")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentID,PaymentType")] Payment payment)
        {
            if (ModelState.IsValid)
            {
