...
namespace AmazonMVCv2.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailsID,ProductID,OrderID,Price,Quantity,Total")] OrderDetail orderDetail)
        {
            ...
            ViewBag.OrderID = new SelectList(db.Orders, "OrdersID", "OrdersID", orderDetail.OrderID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailsID,ProductID,OrderID,Price,Quantity,Total")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
