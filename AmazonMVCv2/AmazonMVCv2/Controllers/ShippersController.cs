...
namespace AmazonMVCv2.Controllers
{
    public class ShippersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipperID,CompanyName")] Shipper shipper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShipperID,CompanyName")] Shipper shipper)
        {
            if (ModelState.IsValid)
            {
